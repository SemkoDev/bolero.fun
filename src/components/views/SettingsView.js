...
export default class SettingsView extends Component {
  ...
  render() {
    ...
    return (
      <Container>
        <Segment basic>
          <Segment>
            <Header as="h3">Deviota Settings</Header>
            <Form onSubmit={this.handleSubmit} loading={this.props.saving}>
              <Message
                color="blue"
                icon="idea"
                header="Your node name"
                content="This will be your identifier shown on field.deviota.com. This identifier will also be used for the Nelson network."
              />
              <Form.Input
  ...
  handleSubmit() {
    ...
    if (address.length && seed.length) {
      ...
      address.length &&
      (!isAddress(address) || !isValidChecksum(address))
    ) {
